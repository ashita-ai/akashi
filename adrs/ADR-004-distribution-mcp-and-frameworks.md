...
- A shared service layer (`internal/service/decisions/`) that both HTTP handlers and MCP handlers delegate to, ensuring consistent behavior for embedding generation, quality scoring, transactional writes, and billing metering.
