...
- Adding new roles requires updating the `RoleRank` function and any `requireRole` middleware invocations. The numeric rank gap between `org_owner` (4) and `platform_admin` (100) provides room for intermediate roles.
