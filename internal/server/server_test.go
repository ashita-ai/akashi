...
func TestHandleRotateKey_InvalidUUIDCov2(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/keys/not-a-uuid/rotate", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
...
func TestHandleRotateKey_AlreadyRevokedCov2(t *testing.T) {
	// Create agent, find key, revoke it, then try to rotate.
	createAgent(testSrv.URL, adminToken, "revrot-agent", "RevRot Agent", "agent", "revrot-agent-key")
	...
	// Attempt rotation on revoked key.
	rotResp, err := authedRequest("POST", testSrv.URL+"/v1/keys/"+keyID.String()+"/rotate", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = rotResp.Body.Close() }()
	assert.Equal(t, http.StatusConflict, rotResp.StatusCode)
...
func TestHandleUpdateAgent_EmptyNameCov2(t *testing.T) {
	resp, err := authedRequest("PATCH", testSrv.URL+"/v1/agents/test-agent", adminToken,
		map[string]any{"name": ""})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
...
func TestHandleUpdateAgent_NoFieldsProvidedCov2(t *testing.T) {
	resp, err := authedRequest("PATCH", testSrv.URL+"/v1/agents/test-agent", adminToken,
		map[string]any{})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
...
func TestHandleUpdateAgent_NotFoundCov2(t *testing.T) {
	resp, err := authedRequest("PATCH", testSrv.URL+"/v1/agents/nonexistent-update-agent", adminToken,
		map[string]any{"name": "test"})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusNotFound, resp.StatusCode)
...
// ===========================================================================
// Coverage push: HandleCreateAgent — validation paths
// ===========================================================================

func TestHandleCreateAgent_ReservedIDCov2(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/agents", adminToken,
		model.CreateAgentRequest{AgentID: "system", Name: "System", Role: model.RoleAgent, APIKey: "sys-key"})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
}

func TestHandleCreateAgent_InvalidRoleCov2(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/agents", adminToken,
		model.CreateAgentRequest{AgentID: "invalid-role-agent", Name: "Bad Role", Role: "super_admin", APIKey: "k"})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
}
...
func TestHandleCreateAgent_ServerGeneratedKeyCov2(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/agents", adminToken,
		model.CreateAgentRequest{AgentID: "auto-key-agent", Name: "Auto Key Agent", Role: model.RoleAgent})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusCreated, resp.StatusCode)
	...
	b, _ := io.ReadAll(resp.Body)
	require.NoError(t, json.Unmarshal(b, &result))
	assert.NotEmpty(t, result.Data.RawKey, "server-generated key should be in response")
}

// ===========================================================================
// Coverage push: HandleListConflicts — filter parameters
// ===========================================================================

func TestHandleListConflicts_WithStatusFilterCov2(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/conflicts?status=open", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
...
func TestHandleListConflicts_WithDecisionTypeFilterCov2(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/conflicts?decision_type=architecture", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
...
func TestHandleListConflicts_WithAgentFilterCov2(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/conflicts?agent_id=test-agent", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
}

func TestHandleListConflicts_WithPaginationCov2(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/conflicts?limit=5&offset=0", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
...
// ===========================================================================
// Coverage push: HandleListConflictGroups — filter parameters
// ===========================================================================

func TestHandleListConflictGroups_WithFiltersCov2(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/conflict-groups?status=open&decision_type=architecture", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
}
...
func TestHandleConflictAnalytics_InvalidPeriodCov2(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/conflicts/analytics?period=invalid", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
...
// ===========================================================================
// Coverage push: HandleGetUsage — paths
// ===========================================================================

func TestHandleGetUsage_DefaultPeriodCov2(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/usage", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
...
func TestHandleGetUsage_InvalidPeriodFormatCov2(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/usage?period=not-a-date", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
}
...
// ===========================================================================
// Coverage push: HandleAppendEvents — empty events array
// ===========================================================================

func TestHandleAppendEvents_EmptyEventsArrayCov2(t *testing.T) {
	// Create a run first.
	runResp, err := authedRequest("POST", testSrv.URL+"/v1/runs", agentToken,
		map[string]any{"agent_id": "test-agent"})
	require.NoError(t, err)
	...
	// Append empty events array.
	resp, err := authedRequest("POST", testSrv.URL+"/v1/runs/"+runResult.Data.ID.String()+"/events", agentToken,
		model.AppendEventsRequest{Events: []model.EventInput{}})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
...
// ===========================================================================
// Coverage push: HandleCompleteRun — invalid status
// ===========================================================================

func TestHandleCompleteRun_InvalidStatusCov2(t *testing.T) {
	runResp, err := authedRequest("POST", testSrv.URL+"/v1/runs", agentToken,
		map[string]any{"agent_id": "test-agent"})
	require.NoError(t, err)
	var runResult struct {
	...
	resp, err := authedRequest("POST", testSrv.URL+"/v1/runs/"+runResult.Data.ID.String()+"/complete", agentToken,
		map[string]any{"status": "invalid-status"})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
}
...
// ===========================================================================
// Coverage push: HandleHealth — response structure
// ===========================================================================

func TestHandleHealth_ResponseFieldsCov2(t *testing.T) {
	resp, err := http.Get(testSrv.URL + "/health")
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
...
func TestHandleSetRetention_InvalidDaysCov2(t *testing.T) {
	resp, err := authedRequest("PUT", testSrv.URL+"/v1/retention", adminToken,
		map[string]any{"retention_days": -1})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
...
func TestHandlePurge_MissingBeforeCov2(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/retention/purge", adminToken,
		map[string]any{})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
...
func TestHandlePurge_DryRunCov2(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/retention/purge", adminToken,
		map[string]any{
			"before":  time.Now().Add(-24 * time.Hour).UTC().Format(time.RFC3339),
			"dry_run": true,
		})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
...
func TestHandlePurge_RealPurgeCov2(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/retention/purge", adminToken,
		map[string]any{
			"before":        time.Now().Add(-365 * 24 * time.Hour).UTC().Format(time.RFC3339),
			"decision_type": "nonexistent-type",
...
func TestHandleGetAgent_NotFoundCov2(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/agents/nonexistent-agent-get", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusNotFound, resp.StatusCode)
}
...
// ===========================================================================
// Coverage push: HandleTemporalQuery — paths
// ===========================================================================

func TestHandleTemporalQuery_FutureAsOfCov2(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/query/temporal", adminToken,
		map[string]any{
...
// ===========================================================================
// Coverage push: HandleTrace — forbidden for non-owner agent
// ===========================================================================

func TestHandleTrace_AgentCannotTraceForOtherCov2(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/trace", agentToken,
		model.TraceRequest{
			AgentID: "admin", // agent token cannot trace for admin
			Decision: model.TraceDecision{
				DecisionType: "test",
				Outcome:      "forbidden attempt",
				Confidence:   0.9,
			},
		})
	require.NoError(t, err)
...
func TestHandleTrace_MissingOutcomeCov2(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/trace", agentToken,
		model.TraceRequest{
			AgentID: "test-agent",
			Decision: model.TraceDecision{
...
func TestHandleTrace_MissingAgentIDCov2(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/trace", agentToken,
		model.TraceRequest{
			Decision: model.TraceDecision{
				DecisionType: "test",
...
// ===========================================================================
// Coverage push: HandleExportDecisions — query parameters
// ===========================================================================

func TestHandleExportDecisions_NDJSONCov2(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/export/decisions", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
...
func TestHandleExportDecisions_WithAgentFilterCov2(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/export/decisions?agent_id=test-agent", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
...
// ===========================================================================
// Coverage push round 5: target 79.1% -> 82%+
// ===========================================================================

func TestHandleTrace_ConfidenceAboveOneR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/trace", adminToken, map[string]any{
		"agent_id": "admin",
		"decision": map[string]any{
			"decision_type": "test",
...
func TestHandleTrace_ConfidenceBelowZeroR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/trace", adminToken, map[string]any{
		"agent_id": "admin",
		"decision": map[string]any{
			"decision_type": "test",
...
func TestHandleTrace_MissingOutcomeR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/trace", adminToken, map[string]any{
		"agent_id": "admin",
		"decision": map[string]any{
			"decision_type": "test",
...
func TestHandleTrace_MissingDecisionTypeR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/trace", adminToken, map[string]any{
		"agent_id": "admin",
		"decision": map[string]any{
			"decision_type": "",
...
func TestHandleTrace_AgentCannotTraceForOtherR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/trace", agentToken, map[string]any{
		"agent_id": "admin",
		"decision": map[string]any{
			"decision_type": "test",
...
func TestHandleTrace_AdminTracesForAgentR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/trace", adminToken, map[string]any{
		"agent_id": "test-agent",
		"decision": map[string]any{
			"decision_type": "coverage-r5",
			"outcome":       "admin tracing on behalf of agent",
			"confidence":    0.8,
		},
	})
	require.NoError(t, err)
...
func TestHandleTrace_AutoRegisterAgentR5(t *testing.T) {
	agentID := fmt.Sprintf("autoreg-r5-%s", uuid.New().String()[:8])
	resp, err := authedRequest("POST", testSrv.URL+"/v1/trace", adminToken, map[string]any{
		"agent_id": agentID,
		"decision": map[string]any{
			"decision_type": "coverage-r5",
			"outcome":       "auto-registered agent",
			"confidence":    0.6,
		},
	})
	require.NoError(t, err)
...
func TestHandleCompleteRun_InvalidStatusValueR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/runs", adminToken, map[string]any{"agent_id": "admin"})
	require.NoError(t, err)
	var run struct {
		Data struct {
			ID string `json:"id"`
	...
	resp2, err := authedRequest("POST", testSrv.URL+"/v1/runs/"+run.Data.ID+"/complete", adminToken, map[string]any{
		"status": "bogus",
	})
	require.NoError(t, err)
	defer func() { _ = resp2.Body.Close() }()
...
func TestHandleCompleteRun_WithFailedStatusR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/runs", adminToken, map[string]any{"agent_id": "admin"})
	require.NoError(t, err)
	var run struct {
		Data struct {
...
func TestHandleCompleteRun_AgentCannotCompleteOthersR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/runs", adminToken, map[string]any{"agent_id": "admin"})
	require.NoError(t, err)
	var run struct {
		Data struct {
	...
	resp2, err := authedRequest("POST", testSrv.URL+"/v1/runs/"+run.Data.ID+"/complete", agentToken, map[string]any{
		"status": "completed",
	})
	require.NoError(t, err)
	defer func() { _ = resp2.Body.Close() }()
...
func TestHandleUpdateAgent_NameAndMetadataR5(t *testing.T) {
	agentID := fmt.Sprintf("upd-r5-%s", uuid.New().String()[:8])
	createAgent(testSrv.URL, adminToken, agentID, "Original", "agent", "key-"+agentID)

	resp, err := authedRequest("PATCH", testSrv.URL+"/v1/agents/"+agentID, adminToken, map[string]any{
		"name":     "Updated Name",
	...
	assert.Equal(t, "Updated Name", result.Data.Name)
	assert.Equal(t, "value", result.Data.Metadata["key"])
}

func TestHandleUpdateAgent_NeitherFieldR5(t *testing.T) {
	resp, err := authedRequest("PATCH", testSrv.URL+"/v1/agents/admin", adminToken, map[string]any{})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
}

func TestHandleGetUsage_InvalidPeriodR5(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/usage?period=not-a-date", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
...
func TestHandleGetUsage_SpecificPeriodR5(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/usage?period=2025-06", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
}

func TestHandleCreateKey_PastExpiresAtR5(t *testing.T) {
	past := time.Now().Add(-24 * time.Hour).Format(time.RFC3339)
	resp, err := authedRequest("POST", testSrv.URL+"/v1/keys", adminToken, map[string]any{
		"agent_id": "admin", "expires_at": past,
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
...
func TestHandleCreateKey_ValidWithExpiresAtR5(t *testing.T) {
	future := time.Now().Add(24 * time.Hour).Format(time.RFC3339)
	resp, err := authedRequest("POST", testSrv.URL+"/v1/keys", adminToken, map[string]any{
		"agent_id": "admin", "expires_at": future,
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusCreated, resp.StatusCode)
...
func TestHandleCreateKey_InvalidAgentIDR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/keys", adminToken, map[string]any{
		"agent_id": "!!bad!!",
	})
	require.NoError(t, err)
...
func TestHandleCreateHold_ToBeforeFromR5(t *testing.T) {
	now := time.Now().UTC()
	resp, err := authedRequest("POST", testSrv.URL+"/v1/retention/hold", adminToken, map[string]any{
		"reason": "test hold",
		"from":   now.Format(time.RFC3339),
...
func TestHandleCreateHold_MissingReasonR5(t *testing.T) {
	now := time.Now().UTC()
	resp, err := authedRequest("POST", testSrv.URL+"/v1/retention/hold", adminToken, map[string]any{
		"reason": "", "from": now.Format(time.RFC3339), "to": now.Add(time.Hour).Format(time.RFC3339),
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
...
func TestHandleCreateHold_MissingDatesR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/retention/hold", adminToken, map[string]any{
		"reason": "test hold",
	})
	require.NoError(t, err)
...
func TestHandleReleaseHold_NonexistentR5(t *testing.T) {
...
func TestHandleHealth_FullResponseShapeR5(t *testing.T) {
	resp, err := http.Get(testSrv.URL + "/health")
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
...
func TestHandleScopedToken_ValidImpersonationR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/auth/scoped-token", adminToken, map[string]any{
		"as_agent_id": "test-agent",
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	...
	require.NoError(t, json.NewDecoder(resp.Body).Decode(&result))
	assert.NotEmpty(t, result.Data.Token)
	assert.Equal(t, "test-agent", result.Data.AsAgentID)
	assert.Equal(t, "admin", result.Data.ScopedBy)
}

func TestHandleScopedToken_CannotEscalateRoleR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/auth/scoped-token", adminToken, map[string]any{
		"as_agent_id": "test-org-owner",
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusForbidden, resp.StatusCode)
...
func TestHandleScopedToken_ScopedTokenCannotRescopeR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/auth/scoped-token", adminToken, map[string]any{
		"as_agent_id": "test-agent",
	})
	require.NoError(t, err)
	...
	resp2, err := authedRequest("POST", testSrv.URL+"/v1/auth/scoped-token", result.Data.Token, map[string]any{
		"as_agent_id": "admin",
	})
	require.NoError(t, err)
	defer func() { _ = resp2.Body.Close() }()
...
func TestHandleScopedToken_WithExpiresInR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/auth/scoped-token", adminToken, map[string]any{
		"as_agent_id": "test-agent",
		"expires_in":  120,
	})
...
func TestHandleAgentHistory_InvalidFromParamR5(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/agents/admin/history?from=not-a-date", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
}

func TestHandleAgentHistory_InvalidToParamR5(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/agents/admin/history?to=not-a-date", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
}

func TestHandleDeleteGrant_AgentCannotDeleteOthersR5(t *testing.T) {
	readerID := fmt.Sprintf("rdr-r5-%s", uuid.New().String()[:8])
	createAgent(testSrv.URL, adminToken, readerID, "Reader", "reader", "key-"+readerID)
	resp, err := authedRequest("POST", testSrv.URL+"/v1/grants", adminToken, map[string]any{
		"grantee_agent_id": readerID,
		"resource_type":    "agent_traces",
		"resource_id":      "admin",
		"permission":       "read",
	})
	...
	resp2, err := authedRequest("DELETE", testSrv.URL+"/v1/grants/"+grant.Data.ID, agentToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp2.Body.Close() }()
	assert.Equal(t, http.StatusForbidden, resp2.StatusCode)
}

func TestHandleCreateGrant_AgentCanGrantOwnTracesR5(t *testing.T) {
	readerID := fmt.Sprintf("rdr2-r5-%s", uuid.New().String()[:8])
	createAgent(testSrv.URL, adminToken, readerID, "Reader", "reader", "key-"+readerID)

	resp, err := authedRequest("POST", testSrv.URL+"/v1/grants", agentToken, map[string]any{
		"grantee_agent_id": readerID,
		"resource_type":    "agent_traces",
...
func TestHandleCreateGrant_AgentCannotGrantOtherTracesR5(t *testing.T) {
	readerID := fmt.Sprintf("rdr3-r5-%s", uuid.New().String()[:8])
	createAgent(testSrv.URL, adminToken, readerID, "Reader", "reader", "key-"+readerID)
...
func TestHandleCreateAgent_InvalidRoleR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/agents", adminToken, map[string]any{
		"agent_id": "inv-role-r5", "name": "Test", "role": "nonexistent_role",
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
...
func TestHandleCreateAgent_CannotCreateHigherRoleR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/agents", adminToken, map[string]any{
		"agent_id": "higher-role-r5", "name": "Test", "role": "org_owner",
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusForbidden, resp.StatusCode)
...
func TestHandleCreateAgent_DuplicateAgentIDR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/agents", adminToken, map[string]any{
		"agent_id": "test-agent", "name": "Duplicate", "role": "agent", "api_key": "dup-key",
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusConflict, resp.StatusCode)
...
func TestHandleCreateAgent_ServerGeneratesKeyR5(t *testing.T) {
	agentID := fmt.Sprintf("nokey-r5-%s", uuid.New().String()[:8])
	resp, err := authedRequest("POST", testSrv.URL+"/v1/agents", adminToken, map[string]any{
		"agent_id": agentID, "name": "No Key Agent", "role": "agent",
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusCreated, resp.StatusCode)
	...
	require.NoError(t, json.NewDecoder(resp.Body).Decode(&result))
	assert.NotEmpty(t, result.Data.RawKey)
}

func TestHandleCreateAgent_InvalidTagR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/agents", adminToken, map[string]any{
		"agent_id": "tagbad-r5", "name": "Bad Tag", "role": "agent",
		"tags":    []string{"this tag is way too long and also has spaces which should be invalid xxxxxxxxxxxxxxxxx"},
		"api_key": "key-tagbad-r5",
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
...
func TestHandleListConflicts_DefaultParamsR5(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/conflicts", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
...
func TestHandleDecisionConflicts_LargeLimit200CapR5(t *testing.T) {
	decID := uuid.New().String()
	resp, err := authedRequest("GET", testSrv.URL+"/v1/decisions/"+decID+"/conflicts?limit=500", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
}

func TestHandleQuery_OffsetExceedsMaxR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/query", adminToken, map[string]any{
...
func TestHandleQuery_NegativeLimitR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/query", adminToken, map[string]any{
		"limit": -5,
	})
	require.NoError(t, err)
...
func TestHandleQuery_LimitExceedsMaxR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/query", adminToken, map[string]any{
		"limit": 5000,
	})
	require.NoError(t, err)
...
func TestHandleDecisionsRecent_DefaultParamsR5(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/decisions/recent", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
	var result struct {
...
func TestHandleDecisionsRecent_WithAgentIDR5(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/decisions/recent?agent_id=admin", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
}

func TestHandleConfig_SearchEnabledR5(t *testing.T) {
	resp, err := http.Get(testSrv.URL + "/config")
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
...
func TestHandleUpdateAgentTags_EmptyTagsListR5(t *testing.T) {
	agentID := fmt.Sprintf("tags-e-r5-%s", uuid.New().String()[:8])
	createAgent(testSrv.URL, adminToken, agentID, "Tags", "agent", "key-"+agentID)
	resp, err := authedRequest("PATCH", testSrv.URL+"/v1/agents/"+agentID+"/tags", adminToken, map[string]any{
		"tags": []string{},
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
...
func TestHandleUpdateAgentTags_NilTagsR5(t *testing.T) {
	resp, err := authedRequest("PATCH", testSrv.URL+"/v1/agents/admin/tags", adminToken, map[string]any{})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
}

func TestHandleUpdateAgentTags_DuplicateTagsR5(t *testing.T) {
	agentID := fmt.Sprintf("tags-d-r5-%s", uuid.New().String()[:8])
	createAgent(testSrv.URL, adminToken, agentID, "Dup Tags", "agent", "key-"+agentID)
	resp, err := authedRequest("PATCH", testSrv.URL+"/v1/agents/"+agentID+"/tags", adminToken, map[string]any{
...
func TestHandleListGrants_HighOffsetEmptyR5(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/grants?limit=1&offset=99999", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
}

func TestHandlePurge_RealNothingToDeleteR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/retention/purge", adminToken, map[string]any{
...
func TestHandleAppendEvents_EmptyArrayR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/runs", adminToken, map[string]any{"agent_id": "admin"})
	require.NoError(t, err)
	var run struct {
		Data struct {
	...
	resp2, err := authedRequest("POST", testSrv.URL+"/v1/runs/"+run.Data.ID+"/events", adminToken, map[string]any{
		"events": []any{},
	})
	require.NoError(t, err)
	defer func() { _ = resp2.Body.Close() }()
...
func TestHandleAppendEvents_AgentCannotAppendToOthersR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/runs", adminToken, map[string]any{"agent_id": "admin"})
	require.NoError(t, err)
	var run struct {
		Data struct {
	...
	resp2, err := authedRequest("POST", testSrv.URL+"/v1/runs/"+run.Data.ID+"/events", agentToken, map[string]any{
		"events": []map[string]any{{"event_type": "test", "payload": map[string]any{"x": 1}}},
	})
	require.NoError(t, err)
	defer func() { _ = resp2.Body.Close() }()
	assert.Equal(t, http.StatusForbidden, resp2.StatusCode)
...
func TestHandleCreateRun_AgentOwnRunOnlyR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/runs", agentToken, map[string]any{
		"agent_id": "admin",
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
...
func TestHandleGetRun_FullResponseR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/runs", adminToken, map[string]any{"agent_id": "admin"})
	require.NoError(t, err)
	var run struct {
		Data struct {
	...
	// Add event.
	resp2, err := authedRequest("POST", testSrv.URL+"/v1/runs/"+run.Data.ID+"/events", adminToken, map[string]any{
		"events": []map[string]any{{"event_type": "DecisionMade", "payload": map[string]any{"foo": "bar"}}},
	})
	require.NoError(t, err)
	_ = resp2.Body.Close()

	// Complete.
	resp3, err := authedRequest("POST", testSrv.URL+"/v1/runs/"+run.Data.ID+"/complete", adminToken, map[string]any{
		"status": "completed",
	})
	require.NoError(t, err)
	_ = resp3.Body.Close()
	...
	// Get full run.
	resp4, err := authedRequest("GET", testSrv.URL+"/v1/runs/"+run.Data.ID, adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp4.Body.Close() }()
	...
	require.NoError(t, json.NewDecoder(resp4.Body).Decode(&result))
	assert.NotNil(t, result.Data.Run)
	assert.NotNil(t, result.Data.Events)
}

func TestHandleTraceHealth_SuccessR5(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/trace-health", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
...
func TestHandleSearch_WithFiltersR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/search", adminToken, map[string]any{
		"query": "test decision", "filters": map[string]any{"agent_ids": []string{"admin"}}, "limit": 5,
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
	assert.NotEmpty(t, resp.Header.Get("X-Search-Backend"))
}

func TestHandleSearch_OverLargeLimitR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/search", adminToken, map[string]any{
...
func TestHandleCheck_WithLimitR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/check", adminToken, map[string]any{
		"decision_type": "test", "limit": 3,
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
...
func TestHandleTemporalQuery_WithFiltersR5(t *testing.T) {
	now := time.Now().UTC()
	resp, err := authedRequest("POST", testSrv.URL+"/v1/query/temporal", adminToken, map[string]any{
		"as_of": now.Add(-1 * time.Hour).Format(time.RFC3339),
		"filters": map[string]any{
			"agent_ids": []string{"admin"}, "decision_type": "test",
		},
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
...
func TestHandleAuthToken_WrongKeyR5(t *testing.T) {
	body, _ := json.Marshal(map[string]any{"agent_id": "admin", "api_key": "wrong-key"})
	resp, err := http.Post(testSrv.URL+"/auth/token", "application/json", bytes.NewReader(body))
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusUnauthorized, resp.StatusCode)
...
func TestHandleListAgents_DefaultR5(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/agents", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
...
func TestHandleMCPInfo_FullResponseR5(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/mcp/info", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusOK, resp.StatusCode)
	var result struct {
...
func TestHandleResolveConflictGroup_NonexistentR5(t *testing.T) {
	resp, err := authedRequest("PATCH", testSrv.URL+"/v1/conflict-groups/"+uuid.New().String()+"/resolve", adminToken, map[string]any{
		"status":          "resolved",
...
func TestHandleAssessDecision_InvalidDecisionUUIDR5(t *testing.T) {
	resp, err := authedRequest("POST", testSrv.URL+"/v1/decisions/not-a-uuid/assess", adminToken, map[string]any{
		"verdict": "agreed",
	})
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
...
func TestHandleListAssessments_InvalidDecisionUUIDR5(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/decisions/not-a-uuid/assessments", adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusBadRequest, resp.StatusCode)
...
func TestHandleGetDecision_NotFoundR5(t *testing.T) {
	resp, err := authedRequest("GET", testSrv.URL+"/v1/decisions/"+uuid.New().String(), adminToken, nil)
	require.NoError(t, err)
	defer func() { _ = resp.Body.Close() }()
	assert.Equal(t, http.StatusNotFound, resp.StatusCode)
