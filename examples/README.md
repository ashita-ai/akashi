...
| `langchain/main.py` | Python | LangChain `AkashiCallbackHandler` — automatic check/trace | No (Postgres only) + `OPENAI_API_KEY` (live mode) |
...
python examples/langchain/main.py                          # pre-scripted
OPENAI_API_KEY=... python examples/langchain/main.py --live # real LLM
```
...
The `examples/langchain/` directory demonstrates `AkashiCallbackHandler` end-to-end.
