...
# The org_id for the default org — uuid.Nil.
...
TEMPLATES = {
    ...
    "trade_off": [
        ...
        ("cost_vs_quality", "Chose {tier} tier at ${cost}/month for {service}",
         "Higher tier offers {extra_feature} but costs {multiplier}x more. Current {metric} is {current_val}, upgrade would give {better_val}. ROI threshold: {roi_months} months."),
...
FILLS = {
    ...
    "tier": ["standard", "performance", "dedicated"],
    "multiplier": [2, 3, 5, 10],
    "extra_feature": ["99.99% SLA", "dedicated instances", "custom model", "priority queue"],
    "current_val": ["99.5%", "500ms p99", "10K req/s"],
    "better_val": ["99.99%", "100ms p99", "100K req/s"],
