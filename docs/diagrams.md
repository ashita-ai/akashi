...
which orchestrates quota enforcement, embedding generation, quality scoring, and
an atomic transactional write. Notification and usage metering happen after the
