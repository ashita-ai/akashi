...
-- agents: add org_id with default, backfill, make NOT NULL.
-- The DEFAULT ensures existing Go code (which doesn't pass org_id yet) continues
-- to work until Phase 2 updates all INSERT statements. Phase 2 will DROP DEFAULT
-- after all Go code explicitly provides org_id.
ALTER TABLE agents
    ADD COLUMN org_id UUID DEFAULT '00000000-0000-0000-0000-000000000000' REFERENCES organizations(id);
UPDATE agents SET org_id = '00000000-0000-0000-0000-000000000000' WHERE org_id IS NULL;
ALTER TABLE agents ALTER COLUMN org_id SET NOT NULL;

-- Drop old unique constraint on agent_id (was globally unique).
-- The inline UNIQUE on agent_id creates a constraint named agents_agent_id_key.
DO $$
BEGIN
    IF EXISTS (
        ...
        WHERE conrelid = 'agents'::regclass
          AND contype = 'u'
          AND conname = 'agents_agent_id_key'
    ) THEN
...
-- agent_runs: add org_id with default, backfill, make NOT NULL
ALTER TABLE agent_runs
    ADD COLUMN org_id UUID DEFAULT '00000000-0000-0000-0000-000000000000' REFERENCES organizations(id);
UPDATE agent_runs SET org_id = '00000000-0000-0000-0000-000000000000' WHERE org_id IS NULL;
ALTER TABLE agent_runs ALTER COLUMN org_id SET NOT NULL;

CREATE INDEX idx_agent_runs_org ON agent_runs (org_id, id);

-- agent_events: add org_id with default, backfill, make NOT NULL
...
-- decisions: add org_id with default, backfill, make NOT NULL
ALTER TABLE decisions
    ADD COLUMN org_id UUID DEFAULT '00000000-0000-0000-0000-000000000000' REFERENCES organizations(id);
UPDATE decisions SET org_id = '00000000-0000-0000-0000-000000000000' WHERE org_id IS NULL;
...
-- access_grants: add org_id with default, backfill, make NOT NULL
ALTER TABLE access_grants
    ADD COLUMN org_id UUID DEFAULT '00000000-0000-0000-0000-000000000000' REFERENCES organizations(id);
UPDATE access_grants SET org_id = '00000000-0000-0000-0000-000000000000' WHERE org_id IS NULL;
...
-- current_decisions view: recreate (now includes org_id via decisions table)
...
-- for RLS to be effective. This is a deployment concern.
...
-- current_setting('app.org_id', true) returns NULL instead of erroring when unset.
